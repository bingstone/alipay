    ...
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" 
            ...
            <tr height=56>
				...
				?>				
				align=middle>当前用户：<?php echo Yii::app()->admin->name; ?> &nbsp;&nbsp; <a style="color: #fff" 
                                                        href="" 
                                                        target=main>注册管理员</a> &nbsp;&nbsp; <a style="color: #fff" 
                                                        " 
                                                        href="<?php echo MANAGE?>admin/login" target=_top>登陆系统</a>
				<?php } else {?>
                    align=middle>当前用户：<?php echo Yii::app()->admin->name; ?> &nbsp;&nbsp; <a style="color: #fff" 
                                                        href="" 
                                                        target=main>修改口令</a> &nbsp;&nbsp; <a style="color: #fff" 
                                                        onclick="if (confirm('确定要退出吗？')) return true; else return false;" 
                                                        href="<?php echo MANAGE?>admin/logout" target=_top>退出系统</a>
                <?php } ?> 
                </td>
