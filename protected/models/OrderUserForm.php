 ...
 */
class OrderUserForm extends CFormModel
{
	public $username;
	public $password;
	public $rememberMe;
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
			$this->_identity=new BGUserIdentity($this->username,$this->password);
	...
	public function login()
	{
		...
		if($this->_identity->errorCode===BGUserIdentity::ERROR_NONE)
		{
