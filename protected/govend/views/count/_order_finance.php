<?php
echo TbHtml::well('<p>总订单数<b>'.$total.'</b>。成功订单数为<b>'.$total_price.'</b>。</p>', array('size' => TbHtml::WELL_SIZE_SMALL));
?>
<div>
<?php
...
$this->widget(
		...
		array(
				'pluginOptions' => array(
						...
						'yAxis' => array(
								'min' => 0,
								'title' => array('text' => '订单数量'),
						),
						'series' => array(
								array('name' => '未完成数量', 'data' => array_reverse($arry_pending)),
								array('name' => '完成完成', 'data' => array_reverse($arry_success)),
								array('name' => '总数量', 'data' => array_reverse($arry)),													
						),
						'tooltip' => array(
