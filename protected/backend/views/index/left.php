                    ...
                    <table id=child3 style="display: none" cellspacing=0 cellpadding=0 
                        ...
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo MANAGE_IMG_URL; ?>menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
                                   href="<?php echo ADMIN;?>manager/showuser" 
                                   target="right">用户管理</a></td></tr>
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo MANAGE_IMG_URL; ?>menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
                                   href="<?php echo ADMIN;?>manager/adduser" 
                                   target="right">添加用户</a></td></tr>
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo MANAGE_IMG_URL; ?>menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
                                   href="<?php echo ADMIN;?>manager/showmerchant" 
                                   target="right">商户管理</a></td></tr>
                        <tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo MANAGE_IMG_URL; ?>menu_icon.gif" width=9></td>
                            <td><a class=menuchild 
                                   href="<?php echo ADMIN;?>manager/addmerchant" 
