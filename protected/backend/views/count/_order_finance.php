<?php
echo TbHtml::well('<p>总订单数<b>'.$total.'</b>。总订单金额为<b>'.$total_price.'</b>元。</p>', array('size' => TbHtml::WELL_SIZE_SMALL));
?>
<div>
<?php
...
$this->widget(
		...
		array(
				'pluginOptions' => array(
						...
						'yAxis' => array(
								'min' => 0,
								'title' => array('text' => '订单金额'),
						),
						'series' => array(
								array('name' => '未完成金额', 'data' => array_reverse($arry_pending)),
								array('name' => '完成金额', 'data' => array_reverse($arry_success)),
								array('name' => '总金额', 'data' => array_reverse($arry)),													
						),
						'tooltip' => array(
